        ...
        <AnimatePresence>
          {hovered && (
            <motion.div
              ...
              className='absolute -left-12 top-1/2 -translate-y-1/2 w-max rounded-md border border-gray-200 bg-gray-100 px-2 py-0.5 text-xs whitespace-pre text-neutral-700 dark:border-neutral-900 dark:bg-neutral-800 dark:text-white'
            >
              {title}
            </motion.div>
          )}
